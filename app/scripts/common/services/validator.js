(function () {
    ...
    function validator($window) {
        ...
        var regType = {
            ...
            username: {
                tip: '4-20 个字符，可由中文、英文、数字以及符号组成，符号为 ~!@#$%^&*()_+',
            ...
            // state and city can be manual inputed.
            region: {
                tip: '最多 20 个字符，可由中文、英文、数字组成',
                pattern: '^[\\u4e00-\\u9fa5a-zA-Z\\d]*$',
            },
         ...
         * @param {String} pattern 匹配可输入的字符
         * @param {String} dbcsPtn 匹配双字节字符
         * @param {Number} minLen maxLen 最小长度和最大长度
         */
        function isValidTxt(inputStr, pattern, dbcsPtn, minLen, maxLen) {
            var length,
                reg,
                dbcsReg, 
                invalidMsg = '';
